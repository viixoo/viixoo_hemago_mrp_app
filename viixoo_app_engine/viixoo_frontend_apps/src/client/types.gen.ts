...
export type AddComponentsWorkOrder = {
  workorder_id: number;
  product_id: number;
  quantity: number;
};

export type ConsumeComponentsWorkOrder = {
  move_raw_id: number;
  consumed: boolean;
};
...
export type ProductReadItemsResponse = ProductsPublic;
...
export type AddComponentWorkOrderData = {
  requestBody: AddComponentsWorkOrder;
};

export type ConsumeComponentWorkOrderData = {
  requestBody: ConsumeComponentsWorkOrder;
};
